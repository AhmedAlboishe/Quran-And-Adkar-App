...
class Themes {
  static final light = ThemeData(
    ...
    iconButtonTheme: const IconButtonThemeData(
        style: ButtonStyle(iconColor: WidgetStatePropertyAll(ligthiconClr))),
    splashColor: ligthiconClr.withValues(alpha: 0.2),
    hoverColor: Colors.transparent,
    highlightColor: ligthiconClr.withValues(alpha: 0.1),
    fontFamily: 'Ibmp',
  ...
  static final dark = ThemeData(
      ...
      iconButtonTheme: const IconButtonThemeData(
          style: ButtonStyle(iconColor: WidgetStatePropertyAll(darkiconClr))),
      splashColor: darkiconClr.withValues(alpha: 0.2),
      hoverColor: Colors.transparent,
      highlightColor: darkiconClr.withValues(alpha: 0.1),
      fontFamily: 'Ibmp',
